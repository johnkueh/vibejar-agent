...
compatibility: >
  ...
  the bundled plugin or https://vibejar.com/install.sh). Works with Claude
  Cowork, Claude Code, Codex, Grok Build, Cursor, and any coding agent that
  loads Agent Skills (agentskills.io).
metadata:
  author: vibejar
